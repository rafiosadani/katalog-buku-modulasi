      ...
      <table class="table table-bordered">
        ...
        ?>
          <tr>
            ...
            <td><?= $tag; ?></td>
            <td align="center">
              <a href="index.php?include=edit-tag&data=<?= $id_tag; ?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
              <a href="javascript:if(confirm('Anda yakin ingin menghapus data Tag <?= $tag; ?>?'))window.location.href = 'index.php?include=tag&aksi=hapus&data=<?= $id_tag; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
            </td>
          </tr>
        <?php $no++; } ?>
        </tbody>
