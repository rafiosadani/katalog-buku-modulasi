          ...
          <div class="col-sm-7">
            <select class="form-control" id="kategori_buku" name="kategori_buku">
              ...
              while ($data_k = mysqli_fetch_row($query_k)) {
                ...
                $kategori = $data_k[1];
              ?>
              <option value="<?= $id_kategori; ?>" <?php if($id_kategori == $id_kategori_buku) { ?> selected <?php } ?>><?= $kategori; ?></option>
              <?php } ?>
            </select>
          </div>
        </div>
          ...
          <div class="col-sm-7">
            <select class="form-control" id="penerbit" name="penerbit">
              ...
              while ($data_p = mysqli_fetch_row($query_p)) {
                ...
                $penerbit = $data_p[1];
              ?>
              <option value="<?= $id_pen; ?>" <?php if($id_pen == $id_penerbit) { ?> selected <?php } ?>><?= $penerbit; ?></option>
              <?php } ?>
            </select>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <?php
            ...
            while ($data_t = mysqli_fetch_row($query_t)) {
              ...
              $tag = $data_t[1];
          ?>
            <input type="checkbox" name="tag[]" value="<?= $id_tg; ?>" <?php if(in_array($id_tg, $array_tag)) { ?> checked="checked" <?php } ?>> <?= $tag; ?></br>
          <?php } ?>
          </div>
        </div>
