...
<section class="content">
  <div class="card">
      ...
      <table class="table table-bordered">
        ...
        ?>
          <tr>
            ...
            <td><?= $kategori_blog; ?></td></td>
            <td align="center">
              <a href="index.php?include=edit-kategori-blog&&data=<?= $id_kategori_blog; ?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
              <a href="javascript:if(confirm('Anda yakin ingin menghapus data Kategori Blog <?= $kategori_blog; ?>?'))window.location.href = 'index.php?include=kategori-blog&aksi=hapus&data=<?= $id_kategori_blog; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
            </td>
          </tr>
        <?php $no++; } ?>
        </tbody>
    ...
    <?php
      // hitung jumlah semua data kategori blog
