      ...
      <table class="table table-bordered">
        ...
        <?php 
          ...
          if (!empty($katakunci_penerbit)) {
              $sql_k .= " WHERE `penerbit` LIKE '%$katakunci_penerbit%' OR `alamat` LIKE '%$katakunci_penerbit%'";
          } 
        ...
        ?>
          <tr>
            ...
            <td align="center">
              ...
              <a href="javascript:if(confirm('Anda yakin ingin menghapus data Penerbit <?= $penerbit; ?>?'))window.location.href = 'index.php?include=penerbit&aksi=hapus&data=<?= $id_penerbit; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
            </td>
          </tr>
        <?php $no++; } ?>
        </tbody>
