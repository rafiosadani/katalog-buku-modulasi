...
<section id="notes-item">
    <div class="container">
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading"><?= $judul_konten; ?></h2>
                <p class="lead"><?= $isi_konten; ?></p>
            </div>
            <div class="col-md-5">
...
<section id="blog-item" class="mb-4">
    <div class="container">
        ...
        <div class="row mb-2">
        <?php 
            $sql_l = "SELECT `b`.`id_blog`, `b`.`judul`, DATE_FORMAT(`b`.`tanggal`, '%d-%m-%Y'), `k`.`kategori_blog` 
                        FROM `blog` `b`
            ...
            <div class="col-md-6">
                <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static bg-light">
                        <strong class="d-inline-block mb-2 text-success"><?= $kategori_blog; ?></strong>
                        <h3 class="mb-0"><a href="index.php?include=detail-blog&data=<?php echo $id_blog; ?>"><?= $judul_blog; ?></a></h3>
